...
- That's if you had a hard time visualising what a family looked like
```
...
- Ok, cheap gags out of the way now
...
- Army, Lidl, Guide Dogs

- BT, EDF

- using Gatsby in production
...
- who gets data from an API to populate their Gatsby apps
...
- depending on how you get your dat in there to begin with
```
...
```notes
- In some ways it's like a compiler for your web site
...
outside of the data layer, using unstructured data.
